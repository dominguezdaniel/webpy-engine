...
export default function AnalyticsSectionVerticalNav1() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="mx-auto xl:ml-xss xl:pl-4">
    <section className="py-4 overflow-hidden">  <div className="container px-4 mx-auto">    <form abframeid="iframe.0.1635058272519483" abineguid="7CA5D2CC495A4972832AF34E9B1958E0">      <div className="flex items-center justify-between mt-6">        <h2 className="text-2xl font-bold mb-6">Analytics</h2>      </div>  </form></div>  <div className="container px-4 mx-auto">    <div className="flex flex-wrap -m-3">      <div className="w-full sm:w-1/2 md:w-1/4 p-3">        <div className="p-5 h-full text-center bg-white rounded-lg">          <p className="mb-4 text-sm text-neutral-500 font-medium">Visitantes</p>          <h3 className="font-heading mb-1 text-4xl tracking-tight font-bold">45,305</h3>                </div>    </div>      <div className="w-full sm:w-1/2 md:w-1/4 p-3">        <div className="p-5 h-full text-center bg-white rounded-lg">          <p className="mb-4 text-sm text-neutral-500 font-medium">Vistas</p>          <h3 className="font-heading mb-1 text-4xl tracking-tight font-bold">2,942</h3>                </div>    </div>      <div className="w-full sm:w-1/2 md:w-1/4 p-3">        <div className="p-5 h-full text-center bg-white rounded-lg">          <p className="mb-4 text-sm text-neutral-500 font-medium">Tiempo</p>          <h3 className="font-heading mb-1 text-4xl tracking-tight font-bold">$35,690</h3>                </div>    </div>      <div className="w-full sm:w-1/2 md:w-1/4 p-3">        <div className="p-5 h-full text-center bg-white rounded-lg">          <p className="mb-4 text-sm text-neutral-500 font-medium">Interacción</p>          <h3 className="font-heading mb-1 text-4xl tracking-tight font-bold">$21,495</h3>                </div>    </div>  </div></div></section>
          ...
          <div className="flex flex-wrap items-center justify-between -m-2">
            ...
            <div className="w-auto p-2">
              <div className="relative h-full overflow-hidden rounded-full">
                <select className="appearance-none py-1.5 pl-3.5 pr-10 text-sm text-neutral-600 font-medium w-full h-full bg-light outline-none cursor-pointer">
                  <option value="USD">This week</option>
                  <option value="CHF">This month</option>
                  <option value="EUR">This year</option>
                </select>
                <svg className="absolute top-1/2 right-4 transform -translate-y-1/2" width={17} height={16} viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.1673 6L8.50065 10.6667L3.83398 6" stroke="#0C1523" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
          <div className="chart" data-type="line-graph1" />
        </div>
      </div>
    </section>
  </div>
